...
<div class="edit-info-banner">
    ...
    <span>Editing <strong>{{ $service->service_name }}</strong> — changes will be saved immediately after updating.</span>
</div>
...
<div class="form-card">
    <div class="form-card-header">
        ...
        <h6>Update Service Information</h6>
    </div>
    ...
    <form action="{{ route('services.update', $service->id) }}" method="POST">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="service_name" class="form-field @error('service_name') is-invalid @enderror"
                               value="{{ old('service_name', $service->service_name) }}" placeholder="e.g. Solar Panel Installation" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="service_code" class="form-field @error('service_code') is-invalid @enderror"
                               value="{{ old('service_code', $service->service_code) }}" placeholder="e.g. SVC-001">
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="number" name="price" step="0.01" min="0"
                               ...
                               value="{{ old('price', $service->price) }}" placeholder="e.g. 150.00">
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="duration" class="form-field @error('duration') is-invalid @enderror"
                               value="{{ old('duration', $service->duration) }}" placeholder="e.g. 2 hours, 30 minutes">
                    </div>
        ...
        <div class="form-footer">
            ...
            <button type="submit" class="btn-update">
                <i class="bi bi-check2-all"></i> Update Service
            </button>
        </div>
    </form>
</div>
