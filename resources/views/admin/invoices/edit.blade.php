...
{{-- ── Edit Banner ── --}}
<div class="edit-info-banner mb-4">
    <i class="bi bi-info-circle-fill" style="color:#F58220; flex-shrink:0;"></i>
    <span>Editing invoice <strong>{{ $invoice->invoice_no }}</strong> — changes will update payment status automatically.</span>
</div>
...
<div class="form-card">
    ...
    <form action="{{ route('invoices.update', $invoice->id) }}" method="POST" id="invoiceForm">
        ...
        <div class="form-card-body">
                        ...
                        <select name="service_id"
                            ...
                            @foreach($services as $service)
                                <option value="{{ $service->id }}"
                                    {{ old('service_id', $invoice->service_id) == $service->id ? 'selected' : '' }}>
                    ...
                    <div class="field-input-wrap">
                        ...
                        <select name="job_assignment_id"
                            ...
                            @foreach($jobAssignments as $ja)
                                <option value="{{ $ja->id }}"
                                    {{ old('job_assignment_id', $invoice->job_assignment_id) == $ja->id ? 'selected' : '' }}>
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="number" name="subtotal" id="subtotal" step="0.01" min="0"
                               ...
                               value="{{ old('subtotal', number_format($invoice->subtotal, 2, '.', '')) }}"
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="number" name="discount" id="discount" step="0.01" min="0"
                               ...
                               value="{{ old('discount', number_format($invoice->discount, 2, '.', '')) }}"
                ...
                <div class="col-12 col-md-3">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="number" name="tax" id="tax" step="0.01" min="0"
                               ...
                               value="{{ old('tax', number_format($invoice->tax, 2, '.', '')) }}"
                               placeholder="0.00" oninput="recalculate()">
                    </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" id="balanceDisplay" class="form-field"
                               value="₹ {{ number_format($invoice->balance_amount, 2) }}" readonly
            ...
            <div class="row g-4 mb-4">
                <div class="col-12 col-md-4">
                    <label class="field-label">Payment Status Override</label>
                    <div class="field-input-wrap">
                        <i class="bi bi-toggle2-on field-icon"></i>
                        <select name="payment_status"
                                class="form-field form-field-select @error('payment_status') is-invalid @enderror">
                            <option value="">— Auto Calculate —</option>
                            <option value="Unpaid"         {{ old('payment_status', $invoice->payment_status) == 'Unpaid'         ? 'selected' : '' }}>Unpaid</option>
                            <option value="Partially Paid" {{ old('payment_status', $invoice->payment_status) == 'Partially Paid' ? 'selected' : '' }}>Partially Paid</option>
                    ...
                    <div class="field-hint">Leave blank to auto-set based on amounts</div>
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="notes" rows="3"
                                  ...
                                  placeholder="Additional notes, remarks or payment instructions...">{{ old('notes', $invoice->notes) }}</textarea>
                    </div>
