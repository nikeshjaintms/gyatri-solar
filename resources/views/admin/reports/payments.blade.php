...
.pay-summary-card {
    ...
    padding: 20px 20px; box-shadow: 0 2px 12px rgba(0,0,0,0.06);
    border: 1px solid #F0F1F3; transition: all 0.25s;
    display: flex; align-items: center; gap: 16px;
}
.pay-summary-card:hover { transform: translateY(-3px); box-shadow: 0 8px 24px rgba(245,130,32,0.12); }
.pay-icon { width: 48px; height: 48px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.3rem; flex-shrink: 0; }
.pay-icon-blue   { background: rgba(59,130,246,0.1);  color: #3B82F6; }
.pay-icon-green  { background: rgba(16,185,129,0.1);  color: #10B981; }
.pay-icon-red    { background: rgba(239,68,68,0.1);   color: #EF4444; }
.pay-icon-orange { background: rgba(245,130,32,0.12); color: #F58220; }
.pay-icon-gray   { background: rgba(156,163,175,0.15);color: #6B7280; }
.pay-val { font-size: 1.4rem; font-weight: 800; color: #1F2937; line-height: 1; margin-bottom: 3px; }
.pay-lbl { font-size: 0.75rem; color: #6B7280; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600; }
...
.section-heading {
    ...
    letter-spacing: 1px; color: #9CA3AF; margin-bottom: 14px; padding-left: 2px;
}

@media print {
    .sidebar-container, .topbar-container, .filter-section,
    .no-print, .back-link, .report-card-header .d-flex,
    .pay-summary-section { display: none !important; }
...
<div class="page-hero no-print">
    <div class="page-hero-left">
        ...
        <p class="page-hero-sub">Generate and print payment reports for Gayatri Solar Energy</p>
    </div>
...
<div class="print-title">
    Gayatri Solar Energy — Payment Report<br>
