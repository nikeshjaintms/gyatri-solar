...
<div class="edit-info-banner">
    ...
    <span>Editing <strong>{{ $customer->name }}</strong> — changes will be saved immediately after updating.</span>
</div>
    ...
    <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="address" rows="3"
                                  ...
                                  placeholder="e.g. 123 Main St, Suite 100">{{ old('address', $customer->address) }}</textarea>
                    </div>
        ...
        <div class="form-footer">
            ...
            <button type="submit" class="btn-update">
                <i class="bi bi-check2-all"></i> Update Customer
            </button>
        </div>
    </form>
</div>
