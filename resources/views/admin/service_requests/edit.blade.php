...
<div class="form-page-header">
    <h1 class="form-page-title">
        <span class="title-icon"><i class="bi bi-clipboard2-pulse"></i></span>
...
<div class="edit-info-banner">
    ...
    <span>
        Editing request for
        <strong>{{ $serviceRequest->customer->name ?? 'N/A' }}</strong>
        — <strong>{{ $serviceRequest->service->service_name ?? 'N/A' }}</strong>.
                    ...
                    <select name="technician_id"
                        ...
                        @foreach($technicians as $tech)
                            <option value="{{ $tech->id }}"
                                {{ old('technician_id', $serviceRequest->technician_id) == $tech->id ? 'selected' : '' }}>
                                {{ $tech->name }}
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <input type="date" name="request_date"
                           ...
                           value="{{ old('request_date', $serviceRequest->request_date?->format('Y-m-d')) }}"
                           required>
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <input type="date" name="service_date"
                           ...
                           value="{{ old('service_date', $serviceRequest->service_date?->format('Y-m-d')) }}">
                </div>
                ...
                <div class="field-input-wrap">
                    ...
                    <select name="priority"
                        ...
                        @foreach(['Low','Medium','High','Urgent'] as $p)
                            <option value="{{ $p }}"
                                {{ old('priority', $serviceRequest->priority) == $p ? 'selected' : '' }}>
                                {{ $p }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="field-input-wrap">
                    ...
                    <select name="status"
                        ...
                        @foreach(['Pending','Assigned','In Progress','Completed','Cancelled'] as $s)
                            <option value="{{ $s }}"
                                {{ old('status', $serviceRequest->status) == $s ? 'selected' : '' }}>
                                {{ $s }}
                            </option>
                        @endforeach
                    </select>
...
<div class="form-card">
            ...
            <div class="col-12">
                ...
                <div class="field-input-wrap">
                    ...
                    <textarea name="address" rows="2"
                              ...
                              placeholder="e.g. 45 Solar Street, Phase 2, Pune - 411001">{{ old('address', $serviceRequest->address) }}</textarea>
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="Describe the issue or service requirement...">{{ old('description', $serviceRequest->description) }}</textarea>
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <textarea name="remarks" rows="3"
                              ...
                              placeholder="Internal notes, special instructions...">{{ old('remarks', $serviceRequest->remarks) }}</textarea>
                </div>
    ...
    <div class="form-footer">
        ...
        <button type="submit" class="btn-update">
            <i class="bi bi-check2-all"></i> Update Request
        </button>
    </div>
</div>
