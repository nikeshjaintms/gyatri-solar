...
<div class="edit-info-banner">
    ...
    <span>
        ...
        <strong>{{ $jobAssignment->technician?->name ?? 'N/A' }}</strong>
        on <strong>{{ $jobAssignment->serviceRequest?->customer?->name ?? 'N/A' }}</strong>
        — <strong>{{ $jobAssignment->serviceRequest?->service?->service_name ?? 'N/A' }}</strong>.
    </span>
</div>


<form action="{{ route('job-assignments.update', $jobAssignment->id) }}" method="POST">
@csrf
@method('PUT')
                ...
                <div class="field-input-wrap">
                    ...
                    <select name="service_request_id"
                        ...
                        @foreach($serviceRequests as $sr)
                            <option value="{{ $sr->id }}"
                                {{ old('service_request_id', $jobAssignment->service_request_id) == $sr->id ? 'selected' : '' }}>
                    ...
                    <select name="technician_id"
                        ...
                        @foreach($technicians as $tech)
                            <option value="{{ $tech->id }}"
                                {{ old('technician_id', $jobAssignment->technician_id) == $tech->id ? 'selected' : '' }}>
                                {{ $tech->name }}
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <input type="date" name="assigned_date"
                           ...
                           value="{{ old('assigned_date', $jobAssignment->assigned_date?->format('Y-m-d')) }}"
                           required>
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <input type="date" name="scheduled_date"
                           ...
                           value="{{ old('scheduled_date', $jobAssignment->scheduled_date?->format('Y-m-d')) }}">
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <input type="time" name="scheduled_time"
                           ...
                           value="{{ old('scheduled_time', $jobAssignment->scheduled_time) }}">
                </div>
                ...
                <div class="field-input-wrap">
                    ...
                    <select name="priority"
                        ...
                        @foreach(['Low','Medium','High','Urgent'] as $p)
                            <option value="{{ $p }}" {{ old('priority', $jobAssignment->priority) == $p ? 'selected' : '' }}>{{ $p }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="field-input-wrap">
                    ...
                    <select name="status"
                        ...
                        @foreach(['Assigned','Accepted','In Progress','Completed','Cancelled'] as $s)
                            <option value="{{ $s }}" {{ old('status', $jobAssignment->status) == $s ? 'selected' : '' }}>{{ $s }}</option>
                        @endforeach
                    </select>
                </div>
...
<div class="form-card">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <textarea name="work_notes" rows="4"
                              ...
                              placeholder="Work details, tools, safety checks...">{{ old('work_notes', $jobAssignment->work_notes) }}</textarea>
                </div>
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="field-input-wrap">
                    ...
                    <textarea name="remarks" rows="4"
                              ...
                              placeholder="Internal notes, supervisor comments...">{{ old('remarks', $jobAssignment->remarks) }}</textarea>
                </div>
    ...
    <div class="form-footer">
        ...
        <button type="submit" class="btn-update">
            <i class="bi bi-check2-all"></i> Update Assignment
        </button>
    </div>
</div>
