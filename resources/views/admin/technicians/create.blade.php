    ...
    <form action="{{ route('technicians.store') }}" method="POST">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="specialization" class="form-field @error('specialization') is-invalid @enderror"
                               value="{{ old('specialization') }}" placeholder="e.g. Solar Panel Installation">
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="experience" class="form-field @error('experience') is-invalid @enderror"
                               value="{{ old('experience') }}" placeholder="e.g. 5 years / Senior Level">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="address" rows="3"
                                  ...
                                  placeholder="e.g. 789 Maple Ave, Suite 200">{{ old('address') }}</textarea>
                    </div>
        ...
        <div class="form-footer">
            ...
            <button type="submit" class="btn-save">
                <i class="bi bi-check-lg"></i> Save Technician
            </button>
        </div>
    </form>
</div>
