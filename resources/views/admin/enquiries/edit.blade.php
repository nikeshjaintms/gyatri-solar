                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="enquiry_number" class="form-field" style="background-color: #F3F4F6;" 
                               value="{{ old('enquiry_number', $enquiry->enquiry_number) }}" readonly required>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="customer_name" id="customer_name" 
                               ...
                               value="{{ old('customer_name', $enquiry->customer_name) }}" placeholder="Enter Customer Name" required>
                    </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="mobile_number" id="mobile_number" 
                               ...
                               value="{{ old('mobile_number', $enquiry->mobile_number) }}" placeholder="e.g. +91 9876543210" required>
                    </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="email" name="email" id="email" 
                               ...
                               value="{{ old('email', $enquiry->email) }}" placeholder="e.g. customer@example.com">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="address" id="address" rows="2" 
                                  ...
                                  placeholder="Enter complete address...">{{ old('address', $enquiry->address) }}</textarea>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="service_product" class="form-field @error('service_product') is-invalid @enderror"
                               value="{{ old('service_product', $enquiry->service_product) }}" placeholder="e.g. 5kW Solar System Installation" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="date" name="enquiry_date" class="form-field @error('enquiry_date') is-invalid @enderror"
                               value="{{ old('enquiry_date', $enquiry->enquiry_date?->format('Y-m-d')) }}" required>
                    </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="enquiry_source" class="form-field @error('enquiry_source') is-invalid @enderror"
                               value="{{ old('enquiry_source', $enquiry->enquiry_source) }}" placeholder="e.g. Website, Reference, Google Maps">
                    </div>
                    ...
                    <div class="field-input-wrap">
                        ...
                        <select name="assigned_employee_id" class="form-field form-field-select @error('assigned_employee_id') is-invalid @enderror">
                            ...
                            @foreach($employees as $employee)
                                <option value="{{ $employee->id }}" {{ old('assigned_employee_id', $enquiry->assigned_employee_id) == $employee->id ? 'selected' : '' }}>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <select name="status" class="form-field form-field-select @error('status') is-invalid @enderror" required>
                            ...
                            <option value="Follow-up" {{ old('status', $enquiry->status) == 'Follow-up' ? 'selected' : '' }}>Follow-up</option>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="date" name="follow_up_date" class="form-field @error('follow_up_date') is-invalid @enderror"
                               value="{{ old('follow_up_date', $enquiry->follow_up_date?->format('Y-m-d')) }}">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="remarks" rows="3"
                                  ...
                                  placeholder="Enter internal follow-up notes or comments...">{{ old('remarks', $enquiry->remarks) }}</textarea>
                    </div>
