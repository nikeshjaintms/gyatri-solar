...
<div class="form-card">
    ...
    <form action="{{ route('quotations.store') }}" method="POST" id="quotation_form" enctype="multipart/form-data">
        @csrf
                ...
                <table class="table table-bordered bg-white align-middle quotation-items-table" id="items_table" style="min-width: 1050px;">
                    ...
                    <tbody id="items_container">
                        <tr class="item-row">
                            ...
                            <td>
                                <input type="text" name="items[0][unit]" class="form-control item-unit text-center" placeholder="Unit">
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="number" name="items[0][tax_percentage]" class="form-control item-tax-percent text-end" min="0" max="100" step="0.01" value="0.00">
                            </td>
                            <td>
