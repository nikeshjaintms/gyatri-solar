    ...
    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-card-body">
            ...
            <div class="row g-4 mb-2">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="name" class="form-field @error('name') is-invalid @enderror"
                               value="{{ old('name') }}" placeholder="e.g. Mukesh Patel" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="email" name="email" class="form-field @error('email') is-invalid @enderror"
                               value="{{ old('email') }}" placeholder="e.g. mukesh@gayatrisolar.com" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <input type="text" name="mobile_number" class="form-field @error('mobile_number') is-invalid @enderror"
                               value="{{ old('mobile_number') }}" placeholder="e.g. +91 9876543210">
                    </div>
                ...
                <!-- Profile Photo -->
                <div class="col-12 col-md-6">
                    <label class="field-label">Profile Photo <span class="text-muted">(JPG, PNG max 1MB)</span></label>
                    <div class="field-input-wrap">
            ...
            <p class="section-label mt-2">Security Password Credentials</p>
            <div class="row g-4 mb-2">
