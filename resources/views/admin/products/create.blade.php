        ...
        <div class="form-card-body">
            ...
            <div class="row g-4 mb-3">
                ...
                <div class="col-12 col-md-4">
                    <label class="field-label">Product Code <span class="req">*</span></label>
                    <div class="field-input-wrap bg-light">
                        <i class="bi bi-hash field-icon"></i>
                        <input type="text" class="form-field"
                               value="{{ $nextProductCode }}" readonly
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <select name="category" class="form-field form-field-select @error('category') is-invalid @enderror" required>
                            ...
                            <option value="Solar Panels" {{ old('category') == 'Solar Panels' ? 'selected' : '' }}>Solar Panels</option>
                            <option value="Inverters" {{ old('category') == 'Inverters' ? 'selected' : '' }}>Inverters</option>
                            <option value="Batteries" {{ old('category') == 'Batteries' ? 'selected' : '' }}>Batteries</option>
                            <option value="Cables" {{ old('category') == 'Cables' ? 'selected' : '' }}>Cables</option>
                            <option value="Mounting Structure" {{ old('category') == 'Mounting Structure' ? 'selected' : '' }}>Mounting Structure</option>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <select name="unit" class="form-field form-field-select @error('unit') is-invalid @enderror" required>
                            <option value="Nos" {{ old('unit') == 'Nos' ? 'selected' : '' }}>Nos (Numbers)</option>
                ...
                <div class="col-12">
                    ...
                    <div class="field-input-wrap">
                        ...
                        <textarea name="description" rows="3"
                                  ...
                                  placeholder="Enter description, special properties, warranties..."></textarea>
                    </div>
